...
%struct.sched_hint = type { i32, i32, i8, i8, i8, i8, i8, [3 x i8], i64, i64, i64, i8, [23 x i8] }

@__sched_hint.data = weak thread_local(initialexec) global %struct.sched_hint { i32 1397246286, i32 1, i8 0, i8 0, i8 0, i8 0, i8 0, [3 x i8] zeroinitializer, i64 0, i64 0, i64 0, i8 0, [23 x i8] zeroinitializer }, section "__sched_hint", align 64
...
define dso_local void @worker() local_unnamed_addr #0 {
  store i8 1, ptr getelementptr inbounds nuw (%struct.sched_hint, ptr @__sched_hint.data, i32 0, i32 5), align 1
  store i64 3735928559, ptr getelementptr inbounds nuw (%struct.sched_hint, ptr @__sched_hint.data, i32 0, i32 10), align 8
  tail call void @my_cross_process_lock() #3
  tail call void @my_cross_process_unlock() #3
  store i8 0, ptr getelementptr inbounds nuw (%struct.sched_hint, ptr @__sched_hint.data, i32 0, i32 5), align 1
  store i64 0, ptr getelementptr inbounds nuw (%struct.sched_hint, ptr @__sched_hint.data, i32 0, i32 10), align 8
  ret void
}
